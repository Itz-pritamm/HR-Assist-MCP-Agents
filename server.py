...
mcp=FastMCP("Google-HR-Assistant")
...
def onboard_new_employee(employee_name: str, manager_name: str):
    ...
    - Notify the manager about the new employees onboarding..
    -raise ticket for a new laptop ,id card,and other necessary equipment
